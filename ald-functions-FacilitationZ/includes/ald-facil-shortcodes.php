...
function ald_facil_image( $atts, $content = null ) {
...
********************************************************************************/
function ald_facil_bloc_texte_et_image( $atts, $content = null ) {
...
function register_shortcodes(){
   add_shortcode('ald-bloc', 'ald_facil_bloc_texte_et_image');
      add_shortcode('ald-image', 'ald_facil_image');
}
